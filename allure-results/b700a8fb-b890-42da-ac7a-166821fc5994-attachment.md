...
- Name: api/booking/booking-crud.spec.ts >> Booking API — CRUD >> DELETE /booking/:id >> should delete a booking successfully @regression @api @booking
- Location: tests/api/booking/booking-crud.spec.ts:247:9
