...
- Name: ui/admin/admin-navigation.spec.ts >> Admin Panel Navigation >> should navigate to Rooms section @smoke @navigation
- Location: tests/ui/admin/admin-navigation.spec.ts:29:7
