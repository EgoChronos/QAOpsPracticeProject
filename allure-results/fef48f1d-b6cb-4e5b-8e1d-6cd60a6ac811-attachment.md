...
- Name: ui/admin/admin-navigation.spec.ts >> Admin Panel Navigation >> should show admin dashboard after authentication @try @smoke @navigation
- Location: tests/ui/admin/admin-navigation.spec.ts:22:7
