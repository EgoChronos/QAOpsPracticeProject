...
- Name: ui/admin/admin-navigation.spec.ts >> Admin Panel Navigation >> should navigate to Report section @regression @navigation
- Location: tests/ui/admin/admin-navigation.spec.ts:36:7
...
Call log:
  - waiting for getByRole('link', { name: /report/i })
