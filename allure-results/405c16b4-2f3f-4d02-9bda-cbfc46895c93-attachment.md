...
- Name: api/booking/booking-crud.spec.ts >> Booking API — CRUD >> PATCH /booking/:id >> should partially update a booking firstname @regression @api @booking
- Location: tests/api/booking/booking-crud.spec.ts:215:9
