...
- Name: api/booking/booking-crud.spec.ts >> Booking API — CRUD >> PATCH /booking/:id >> should partially update totalprice @regression @api @booking
- Location: tests/api/booking/booking-crud.spec.ts:229:9
