...
- Name: api/booking/booking-crud.spec.ts >> Booking API — CRUD >> PUT /booking/:id >> should fully update a booking @regression @api @booking
- Location: tests/api/booking/booking-crud.spec.ts:180:9
