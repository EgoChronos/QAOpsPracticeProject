...
- Name: api/booking/booking-crud.spec.ts >> Booking API — CRUD >> PUT /booking/:id >> should persist PUT update when retrieved again @regression @api @booking
- Location: tests/api/booking/booking-crud.spec.ts:196:9
