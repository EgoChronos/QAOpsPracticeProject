...
- Name: ui/auth/login.spec.ts >> Authentication >> should logout successfully @smoke @auth
- Location: tests/ui/auth/login.spec.ts:52:7
...
Call log:
  - waiting for getByRole('link', { name: /logout/i })
...
- generic [ref=e1]:
  - generic [ref=e3]:
    - navigation [ref=e4]:
      - generic [ref=e5]:
        - link "Restful Booker Platform Demo" [ref=e6]:
          - /url: /
        - generic [ref=e7]:
          - list
          - list [ref=e8]:
            - listitem [ref=e9]:
              - link "Front Page" [ref=e10]:
                - /url: /
            - listitem [ref=e11]:
    ...
    - generic [ref=e18]:
      ...
      - generic [ref=e21]:
        - alert [ref=e22]: Invalid credentials
        - generic [ref=e23]:
          - generic [ref=e24]:
          ...
          - button "Login" [active] [ref=e30] [cursor=pointer]
  - alert [ref=e32]
```
