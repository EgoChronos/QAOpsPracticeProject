...
- Name: ui/admin/admin-navigation.spec.ts >> Admin Panel Navigation >> should navigate to Branding section @regression @navigation
- Location: tests/ui/admin/admin-navigation.spec.ts:43:7
...
Call log:
  - waiting for getByRole('link', { name: /branding/i })
